...
void :: SigmacordHandler (Either RestCallErrorCode b) -> SigmacordHandler ()
void =
  ( >>=
      ( \case
    ...
    runSigmacord $
      def
        { SigmacordToken = tok,
          ...
          SigmacordOnEnd = liftIO $ putStrLn "Ended",
          SigmacordOnEvent = eventHandler testserverid,
...
eventHandler :: GuildId -> Event -> SigmacordHandler ()
                ...
                Just
                  [ ActionRowButtons
                      [ Button "Button 1" False ButtonStylePrimary (Just "Button 1") (Just (mkEmoji "🔥")),
                        ...
                        ButtonUrl
                          "https://github.com/Sigmacord-haskell/Sigmacord-haskell"
                          False
                          (Just "Button 3")
                          Nothing
                      ],
                ...
                Just
                  [ def
                      { createEmbedTitle = "Title",
                        ...
                        createEmbedImage = Just (CreateEmbedImageUrl "https://media.Sigmacordapp.net/attachments/365969021083975681/936055590415921172/Warning.png"),
                        createEmbedColor = Just SigmacordColorLuminousVividPink,
                      ...
                      Just
                        [ def
                            { createEmbedTitle = "Select menu title",
                              ...
                              createEmbedImage = Just (CreateEmbedImageUrl "https://media.Sigmacordapp.net/attachments/365969021083975681/936055590415921172/Warning.png"),
                              createEmbedColor = Just SigmacordColorSigmacordBlurple,
                              createEmbedAuthorIcon = Just (CreateEmbedImageUpload exampleImage)
                            }
                        ]
                  }
